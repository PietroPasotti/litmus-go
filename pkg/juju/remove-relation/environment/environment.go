...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	experimentDetails.ExperimentName = types.Getenv("EXPERIMENT_NAME", "juju-remove-relation")
	...
	experimentDetails.Endpoint1 = types.Getenv("ENDPOINT1", "")
	experimentDetails.Endpoint2 = types.Getenv("ENDPOINT2", "")
