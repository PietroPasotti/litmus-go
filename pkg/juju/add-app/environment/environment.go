...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	experimentDetails.ExperimentName = types.Getenv("EXPERIMENT_NAME", "juju-add-app")
	...
	experimentDetails.CharmName = types.Getenv("CHARM_NAME", "")
	experimentDetails.AppName = types.Getenv("APP_NAME", "")
	experimentDetails.Channel = types.Getenv("CHANNEL", "stable")
	experimentDetails.NumUnits, _ = strconv.Atoi(types.Getenv("NUM_UNITS", "1"))
	experimentDetails.AppConfig = types.Getenv("APP_CONFIG", "")
