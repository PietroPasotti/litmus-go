...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/juju-add-app/lib"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/juju/add-app/environment"
...
// JujuAddApp is the entry point for the juju-add-app chaos experiment
func JujuAddApp(ctx context.Context, clients clients.ClientSets) {
	...
	log.InfoWithValues("The experiment information is as follows", logrus.Fields{
		...
		"Charm Name":      experimentsDetails.CharmName,
		"App Name":        experimentsDetails.AppName,
		"Channel":         experimentsDetails.Channel,
		"Num Units":       experimentsDetails.NumUnits,
	})
	...
	if err := litmusLIB.PrepareJujuAddApp(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
