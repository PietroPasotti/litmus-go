...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/juju-remove-unit/lib"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/juju/remove-unit/environment"
...
// JujuRemoveUnit is the entry point for the juju-remove-unit chaos experiment
func JujuRemoveUnit(ctx context.Context, clients clients.ClientSets) {
	...
	log.InfoWithValues("The experiment information is as follows", logrus.Fields{
		...
		"Unit IDs":        experimentsDetails.UnitIDs,
	})
	...
	if err := litmusLIB.PrepareJujuRemoveUnit(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
