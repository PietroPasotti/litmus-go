...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/juju-integrate/lib"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/juju/integrate/environment"
...
// JujuIntegrate is the entry point for the juju-integrate chaos experiment
func JujuIntegrate(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PrepareJujuIntegrate(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
