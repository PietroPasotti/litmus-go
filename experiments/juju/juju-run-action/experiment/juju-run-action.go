...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/juju-run-action/lib"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/juju/run-action/environment"
...
// JujuRunAction is the entry point for the juju-run-action chaos experiment
func JujuRunAction(ctx context.Context, clients clients.ClientSets) {
	...
	log.InfoWithValues("The experiment information is as follows", logrus.Fields{
		...
		"Unit Name":       experimentsDetails.UnitName,
		"Action Name":     experimentsDetails.ActionName,
	})
	...
	if err := litmusLIB.PrepareJujuRunAction(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
