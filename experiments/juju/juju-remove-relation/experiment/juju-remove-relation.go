...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/juju-remove-relation/lib"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/juju/remove-relation/environment"
...
// JujuRemoveRelation is the entry point for the juju-remove-relation chaos experiment
func JujuRemoveRelation(ctx context.Context, clients clients.ClientSets) {
	...
	log.InfoWithValues("The experiment information is as follows", logrus.Fields{
		...
		"Endpoint1":       experimentsDetails.Endpoint1,
		"Endpoint2":       experimentsDetails.Endpoint2,
	})
	...
	if err := litmusLIB.PrepareJujuRemoveRelation(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
