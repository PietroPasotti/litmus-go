...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/juju-add-unit/lib"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/juju/add-unit/environment"
...
// JujuAddUnit is the entry point for the juju-add-unit chaos experiment
func JujuAddUnit(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PrepareJujuAddUnit(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
