...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/juju-remove-app/lib"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/juju/remove-app/environment"
...
// JujuRemoveApp is the entry point for the juju-remove-app chaos experiment
func JujuRemoveApp(ctx context.Context, clients clients.ClientSets) {
	...
	if err := litmusLIB.PrepareJujuRemoveApp(ctx, &experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
